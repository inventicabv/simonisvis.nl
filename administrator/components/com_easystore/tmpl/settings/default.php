...
if ($acl->canManageOptions()) {
    $wa->addInlineScript('Joomla.easyStoreBase = "' . Uri::root() . '"')
        ->useScript('keepalive')
        ->useScript('com_easystore.app.admin.settings');
}
$user = Factory::getApplication()->getIdentity();
?>

<?php if ($acl->canManageOptions()) : ?>
    <div id="easystore-admin-settings"></div>
<?php else : ?>
        ...
        <div class="easystore-card">
            <div class="easystore-empty-state">
                ...
                <div class="easystore-empty-state-title mb-2">
                    <?php echo Text::_('COM_EASYSTORE_GLOBAL_PERMISSION_REQUIRED'); ?>
                </div>

                <div class="easystore-empty-state-description mb-4">
                    <?php echo Text::_('COM_EASYSTORE_SETTING_NO_PERMISSION'); ?>
                </div>
            </div>
        </div>
    </div>
