...
?>
<form action="<?php echo Route::_('index.php?option=com_easystore&task=brand.add'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <div class="easystore-card">
        <div class="easystore-empty-state">
            ...
            <div class="easystore-empty-state-title mb-2">
                <?php echo Text::_('COM_EASYSTORE_EMPTYSTATE_BRAND_TITLE'); ?>
            </div>
            
            <div class="easystore-empty-state-description mb-4">
                <?php echo Text::_($acl->canCreate() ? 'COM_EASYSTORE_EMPTYSTATE_BRAND_DESCRIPTION' : 'COM_EASYSTORE_EMPTY_STATE_BRAND_NO_PERMISSION'); ?>
            </div>

            <?php if ($acl->canCreate() || !empty($user->getAuthorisedCategories('com_easystore', 'core.create'))) : ?>
                <div class="easystore-empty-state-actions">
                    <a href="<?php echo Route::_('index.php?option=com_easystore&task=brand.add'); ?>" class="btn btn-primary"><?php echo Text::_('COM_EASYSTORE_EMPTYSTATE_BRAND_BUTTON_TEXT'); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
