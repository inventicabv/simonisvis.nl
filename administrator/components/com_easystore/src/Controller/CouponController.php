...
/**
 * Controller for a single Coupon
 *
 * @since  1.0.0
 */
class CouponController extends FormController
{
    ...
    {
        $acl = AccessControl::create();
        return $acl->canEdit() || $acl->setContext('coupon')->canEditOwn($data[$key]);
    }
    ...
    public function batch($model = null)
    {
        ...
        // Preset the redirect
        $this->setRedirect('index.php?option=com_easystore&view=coupons');
