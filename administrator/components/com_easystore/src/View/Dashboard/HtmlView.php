...
namespace JoomShaper\Component\EasyStore\Administrator\View\Dashboard;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolbarHelper::title(Text::_('COM_EASYSTORE_MANAGER_DASHBOARD'), 'dashboard');
        ...
        $toolbar->help('dashboard', false, 'https://www.joomshaper.com/documentation/easystore/dashboard');
    }
}
