...
/**
 * This models supports retrieving lists of collections.
 *
 * @since   1.4.0
 */
class CollectionsModel extends ListModel
{
    ...
    /**
     * Get the master query for retrieving a list of collections.
     *
    ...
    public function getItems()
    {
        ...
        foreach ($items as &$item) {
            ...
            $item->url = Route::_('index.php?option=com_easystore&view=collection&id=' . $item->id);
        }
